...
class _PetugasHomeScreenState extends State<PetugasHomeScreen> {
              ...
              child: Container(
                ...
                child: GridView.count(
                  ...
                  children: List.generate(choices.length, (index) {
                    return Center(
                      child: PilihCard(choice: choices[index]),
                    );
                  }),
                ),
              ),
  ...
  static const List<Pilihan> choices = const <Pilihan>[
    const Pilihan(
        title: 'Tanya Imam',
...
class Pilihan {
  const Pilihan({required this.title,
    required this.icon,
...
class PilihCard extends StatelessWidget {
  const PilihCard({Key? key, required this.choice}) : super(key: key);
  final Pilihan choice;
